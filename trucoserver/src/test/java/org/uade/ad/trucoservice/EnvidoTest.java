...
public class EnvidoTest {
	...
	public void testCalcular() {
		...
		c1.addAll(Arrays.asList(new Carta(7, "oro", 7, 0, 1), new Carta(6, "oro", 6, 0, 1), new Carta(1, "oro", 1, 0, 1)));
		c2.addAll(Arrays.asList(new Carta(1, "copa", 1, 0, 1), new Carta(1, "espada", 1, 0, 1), new Carta(1, "basto", 1, 0, 1)));
		c3.addAll(Arrays.asList(new Carta(1, "oro", 1, 0, 1), new Carta(1, "oro", 1, 0, 1), new Carta(1, "oro", 1, 0, 1)));
		c4.addAll(Arrays.asList(new Carta(1, "oro", 1, 0, 1), new Carta(1, "oro", 1, 0, 1), new Carta(1, "oro", 1, 0, 1)));
